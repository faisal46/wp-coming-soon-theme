...
*/
function comming_soon_after_setup_theme() {
    load_theme_textdomain( 'comming-soon' );
    add_theme_support( 'post-thumbnails' );
    add_theme_support( 'title-tag' );
}
add_action( 'after_setup_theme', 'comming_soon_after_setup_theme' );

/** 
* Assets management
*/
function comming_soon_assets() {
...
*/
function comming_soon_sidebar_register() {
    register_sidebar(
        array(
          'name'           => sprintf( __( 'Footer Left', 'comming-soon' ) ),
          'id'             => "footer-left",
          'description'    => sprintf( __( 'Footer left sidebar', 'comming-soon' ) ),
    ...
    register_sidebar(
        array(
          'name'           => sprintf( __( 'Footer Right', 'comming-soon' ) ),
          'id'             => "footer-right",
          'description'    => sprintf( __( 'Footer right sidebar', 'comming-soon' ) ),
...
add_action( 'widgets_init', 'comming_soon_sidebar_register' );

/**
 * Page template banner
 */
function comming_soon_page_template_banner(){
...
add_action( 'wp_head', 'comming_soon_page_template_banner' );
